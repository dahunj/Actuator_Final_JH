...
2300 - MANUAL_INDEX_DLG (1)
2400 - MANUAL_INDEX_DLG (2)
2500 - MANUAL_TRANS_DLG (1)
2600 - MANUAL_TRANS_DLG (2)
2700 - MANUAL_NG_DLG (1)
2800 - MANUAL_NG_DLG (2)
2900 - MANUAL_CAP_DLG (1)
3000 - MANUAL_CAP_DLG (2)
3100 - MANUAL_REVERSE_DLG (1)
3200 - MANUAL_SHIP_DLG (1)
3300 - MANUAL_SHIP_DLG (2)
3400 - MANUAL_SHIP_ALN_DLG

4000 - SETUP_DLG
4100 - TOWER_LAMP_BUZZER
4200 - SETUP_EQUIP_DLG
4300 - SETUP_MOVE_DLG (TAB1)
4400 - SETUP_MOVE_DLG (TAB2)
4500 - SETUP_MOVE_DLG (TAB3)
4600 - SETUP_MOVE_DLG (TAB4)
4700 - SETUP_MOVE_DLG (TAB5)
4800 - SETUP_MOVE_DLG (TAB6)
4900 - SETUP_MOVE_DLG (TAB7)
...
================================================================================
    MFC 라이브러리 : CMAI2100 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 CMAI2100 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 CMAI2100 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
CMAI2100.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CCMAI2100App 응용 프로그램
    클래스를 선언합니다.

CMAI2100.cpp
    응용 프로그램 클래스 CCMAI2100App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\CMAI2100.ico
    ...
    주 리소스 파일인 CMAI2100.rc에 의해 포함됩니다.
...
CMAI2100Dlg.h, CMAI2100Dlg.cpp - 대화 상자
    이 파일에는 CCMAI2100Dlg 클래스가 들어 있습니다. 이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다. 대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 CMAI2100.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 CMAI2100.pch와
