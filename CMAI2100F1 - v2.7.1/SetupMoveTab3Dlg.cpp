...
void CSetupMoveTab3Dlg::Save_MoveData()
{
	...
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcInspectionX1[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("24_INSPECT_STAGE_X1", strKey, dData, "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcInspectionX2[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("25_INSPECT_STAGE_X2", strKey, dData, "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcInspectionX3[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("26_INSPECT_STAGE_X3", strKey, dData, "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcInspectionX4[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("27_INSPECT_STAGE_X4", strKey, dData, "%0.3lf"); }
	
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcTOPZ1[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("22_TOP1_VISION_Z", strKey, dData, "%0.3lf"); }
...
//	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcTOP1AngleY[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("44_TOP1_ANGLE_Y", strKey, dData, "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);	m_stcTOPZ2[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("23_TOP2_VISION_Z", strKey, dData, "%0.3lf"); }
	for (int i = 0; i < 4; i++) { strKey.Format("%02d", i);	m_stcShipAlignX[i].GetWindowText(strData);	dData = atof(strData);	INI.Set_Double("40_SHIP_ALIGN_X", strKey, dData, "%0.3lf"); }
