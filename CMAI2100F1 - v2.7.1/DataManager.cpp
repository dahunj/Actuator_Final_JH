...
BOOL CDataManager::Read_EquipData()
{
	...
	for (int i = 0; i < 8; i++) {
		strKey.Format("%02d", i); gData.bNotUseStage[i] = INI.Get_Bool("NOTUSE", strKey, FALSE);
	}
...
BOOL CDataManager::Save_MoveData()
{
	...
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i);		INI.Set_Double("08_TRANSFER_X2",		strKey, m_MoveData.dTransferX2[i],	 "%0.3lf"); }
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i);		INI.Set_Double("09_TRANSFER_Z2",		strKey, m_MoveData.dTransferZ2[i],	 "%0.3lf"); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i);		INI.Set_Double("10_LOAD_STAGE_Y1",		strKey, m_MoveData.dLoadStageY1[i],	 "%0.3lf"); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i);		INI.Set_Double("11_LOAD_STAGE_Y2",		strKey, m_MoveData.dLoadStageY2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("12_LOAD_PICKER_X1",		strKey, m_MoveData.dLoadPickerX1[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("13_LOAD_PICKER_Y1",		strKey, m_MoveData.dLoadPickerY1[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("14_LOAD_PICKER_Z1",		strKey, m_MoveData.dLoadPickerZ1[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("15_LOAD_PICKER_P1",		strKey, m_MoveData.dLoadPickerP1[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("16_LOAD_PICKER_X2",		strKey, m_MoveData.dLoadPickerX2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("17_LOAD_PICKER_Y2",		strKey, m_MoveData.dLoadPickerY2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("18_LOAD_PICKER_Z2",		strKey, m_MoveData.dLoadPickerZ2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("19_LOAD_PICKER_P2",		strKey, m_MoveData.dLoadPickerP2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("20_BTM_CAMERA_Z",		strKey, m_MoveData.dBTMFocusZ[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("21_BTM_LIGHT_Z",		strKey, m_MoveData.dBTMLightZ[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("22_TOP1_VISION_Z",		strKey, m_MoveData.dTOPVisionZ1[i],	 "%0.3lf"); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i);		INI.Set_Double("23_TOP2_VISION_Z",		strKey, m_MoveData.dTOPVisionZ2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("24_INSPECT_STAGE_X1",	strKey, m_MoveData.dVisionStageX1[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("25_INSPECT_STAGE_X2",	strKey, m_MoveData.dVisionStageX2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("26_INSPECT_STAGE_X3",	strKey, m_MoveData.dVisionStageX3[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("27_INSPECT_STAGE_X4",	strKey, m_MoveData.dVisionStageX4[i],	 "%0.3lf"); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i);		INI.Set_Double("28_UNLOAD_PICKER_X1",	strKey, m_MoveData.dUnloadPickerX1[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("29_UNLOAD_PICKER_Y1",	strKey, m_MoveData.dUnloadPickerY1[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("30_UNLOAD_PICKER_Z1",	strKey, m_MoveData.dUnloadPickerZ1[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("31_UNLOAD_PICKER_P1",	strKey, m_MoveData.dUnloadPickerP1[i],	 "%0.3lf"); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i);		INI.Set_Double("32_UNLOAD_PICKER_X2",	strKey, m_MoveData.dUnloadPickerX2[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("33_UNLOAD_PICKER_Y2",	strKey, m_MoveData.dUnloadPickerY2[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("34_UNLOAD_PICKER_Z2",	strKey, m_MoveData.dUnloadPickerZ2[i],	 "%0.3lf"); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i);		INI.Set_Double("35_UNLOAD_PICKER_P2",	strKey, m_MoveData.dUnloadPickerP2[i],	 "%0.3lf"); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i);		INI.Set_Double("36_GOOD_STAGE_Y1",		strKey, m_MoveData.dGoodStageY1[i],	 "%0.3lf"); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i);		INI.Set_Double("37_GOOD_STAGE_Y2",		strKey, m_MoveData.dGoodStageY2[i],	 "%0.3lf"); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i);		INI.Set_Double("38_NG_STAGE_Y1",		strKey, m_MoveData.dNGStageY1[i],	 "%0.3lf"); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i);		INI.Set_Double("39_NG_STAGE_Y2",		strKey, m_MoveData.dNGStageY2[i],	 "%0.3lf"); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i);		INI.Set_Double("40_SHIP_ALIGN_X",		strKey, m_MoveData.dShiipAling[i],	 "%0.3lf"); }
	return TRUE;
}
...
BOOL CDataManager::Read_MoveData()
{
	...
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i); m_MoveData.dTransferX2[i]		= INI.Get_Double("08_TRANSFER_X2",		strKey, 0.0); }
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i); m_MoveData.dTransferZ2[i]		= INI.Get_Double("09_TRANSFER_Z2",		strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveData.dLoadStageY1[i]		= INI.Get_Double("10_LOAD_STAGE_Y1",		strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveData.dLoadStageY2[i]		= INI.Get_Double("11_LOAD_STAGE_Y2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerX1[i]		= INI.Get_Double("12_LOAD_PICKER_X1",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerY1[i]		= INI.Get_Double("13_LOAD_PICKER_Y1",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerZ1[i]		= INI.Get_Double("14_LOAD_PICKER_Z1",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerP1[i]		= INI.Get_Double("15_LOAD_PICKER_P1",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerX2[i]		= INI.Get_Double("16_LOAD_PICKER_X2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerY2[i]		= INI.Get_Double("17_LOAD_PICKER_Y2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerZ2[i]		= INI.Get_Double("18_LOAD_PICKER_Z2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dLoadPickerP2[i]		= INI.Get_Double("19_LOAD_PICKER_P2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dBTMFocusZ[i]		= INI.Get_Double("20_BTM_CAMERA_Z",			strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dBTMLightZ[i]		= INI.Get_Double("21_BTM_LIGHT_Z",			strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dTOPVisionZ1[i]		= INI.Get_Double("22_TOP1_VISION_Z",		strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveData.dTOPVisionZ2[i]		= INI.Get_Double("23_TOP2_VISION_Z",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dVisionStageX1[i]	= INI.Get_Double("24_INSPECT_STAGE_X1",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dVisionStageX2[i]	= INI.Get_Double("25_INSPECT_STAGE_X2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dVisionStageX3[i]	= INI.Get_Double("26_INSPECT_STAGE_X3",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dVisionStageX4[i]	= INI.Get_Double("27_INSPECT_STAGE_X4",		strKey, 0.0); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerX1[i]	= INI.Get_Double("28_UNLOAD_PICKER_X1",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerY1[i]	= INI.Get_Double("29_UNLOAD_PICKER_Y1",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerZ1[i]	= INI.Get_Double("30_UNLOAD_PICKER_Z1",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerP1[i]	= INI.Get_Double("31_UNLOAD_PICKER_P1",		strKey, 0.0); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerX2[i]	= INI.Get_Double("32_UNLOAD_PICKER_X2",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerY2[i]	= INI.Get_Double("33_UNLOAD_PICKER_Y2",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerZ2[i]	= INI.Get_Double("34_UNLOAD_PICKER_Z2",		strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveData.dUnloadPickerP2[i]	= INI.Get_Double("35_UNLOAD_PICKER_P2",		strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveData.dGoodStageY1[i]		= INI.Get_Double("36_GOOD_STAGE_Y1",		strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveData.dGoodStageY2[i]		= INI.Get_Double("37_GOOD_STAGE_Y2",		strKey, 0.0); }
	...
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveData.dShiipAling[i]		= INI.Get_Double("40_SHIP_ALIGN_X",			strKey, 0.0); }
...
BOOL CDataManager::Read_MoveInput()
{
	...
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i); m_MoveInput.dTransferX2[i]		= INI.Get_Double("08_TRANSFER_X2",		strKey, 0.0); }
	for (int i = 0; i <15; i++) { strKey.Format("%02d", i); m_MoveInput.dTransferZ2[i]		= INI.Get_Double("09_TRANSFER_Z2",		strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadStageY1[i]		= INI.Get_Double("10_LOAD_STAGE_Y1",	strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadStageY2[i]		= INI.Get_Double("11_LOAD_STAGE_Y2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerX1[i]	= INI.Get_Double("12_LOAD_PICKER_X1",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerY1[i]	= INI.Get_Double("13_LOAD_PICKER_Y1",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerZ1[i]	= INI.Get_Double("14_LOAD_PICKER_Z1",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerP1[i]	= INI.Get_Double("15_LOAD_PICKER_P1",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerX2[i]	= INI.Get_Double("16_LOAD_PICKER_X2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerY2[i]	= INI.Get_Double("17_LOAD_PICKER_Y2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerZ2[i]	= INI.Get_Double("18_LOAD_PICKER_Z2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dLoadPickerP2[i]	= INI.Get_Double("19_LOAD_PICKER_P2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dBTMFocusZ[i]		= INI.Get_Double("20_BTM_CAMERA_Z",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dBTMLightZ[i]		= INI.Get_Double("21_BTM_LIGHT_Z",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dTOPVisionZ1[i]		= INI.Get_Double("22_TOP1_VISION_Z",	strKey, 0.0); }
	for (int i = 0; i < 7; i++) { strKey.Format("%02d", i); m_MoveInput.dTOPVisionZ2[i]		= INI.Get_Double("23_TOP2_VISION_Z",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dVisionStageX1[i]	= INI.Get_Double("24_INSPECT_STAGE_X1",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dVisionStageX2[i]	= INI.Get_Double("25_INSPECT_STAGE_X2",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dVisionStageX3[i]	= INI.Get_Double("26_INSPECT_STAGE_X3",	strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dVisionStageX4[i]	= INI.Get_Double("27_INSPECT_STAGE_X4",	strKey, 0.0); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerX1[i]	= INI.Get_Double("28_UNLOAD_PICKER_X1",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerY1[i]	= INI.Get_Double("29_UNLOAD_PICKER_Y1",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerZ1[i]	= INI.Get_Double("30_UNLOAD_PICKER_Z1",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerP1[i]	= INI.Get_Double("31_UNLOAD_PICKER_P1",	strKey, 0.0); }
	for (int i = 0; i <20; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerX2[i]	= INI.Get_Double("32_UNLOAD_PICKER_X2",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerY2[i]	= INI.Get_Double("33_UNLOAD_PICKER_Y2",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerZ2[i]	= INI.Get_Double("34_UNLOAD_PICKER_Z2",	strKey, 0.0); }
	for (int i = 0; i < 9; i++) { strKey.Format("%02d", i); m_MoveInput.dUnloadPickerP2[i]	= INI.Get_Double("35_UNLOAD_PICKER_P2",	strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveInput.dGoodStageY1[i]		= INI.Get_Double("36_GOOD_STAGE_Y1",	strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveInput.dGoodStageY2[i]		= INI.Get_Double("37_GOOD_STAGE_Y2",	strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveInput.dNGStageY1[i]		= INI.Get_Double("38_NG_STAGE_Y1",		strKey, 0.0); }
	for (int i = 0; i < 6; i++) { strKey.Format("%02d", i); m_MoveInput.dNGStageY2[i]		= INI.Get_Double("39_NG_STAGE_Y2",		strKey, 0.0); }
	for (int i = 0; i < 5; i++) { strKey.Format("%02d", i); m_MoveInput.dShiipAling[i]		= INI.Get_Double("40_SHIP_ALIGN_X",		strKey, 0.0); }
