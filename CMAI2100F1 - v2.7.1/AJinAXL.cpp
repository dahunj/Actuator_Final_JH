...
void CAJinAXL::Sim_SetOutToIn(int nNo)
{
	...
	if (nNo==3) {
		...
		m_DX03.iTransferZDown		= m_DY03.oTransferZDown;
		m_DX03.iTransferZUp			= m_DY03.oTransferZUp;
		...
		m_DX03.iBTMMirrorIn			= m_DY03.oBTMMirrorIn;
		m_DX03.iBTMMirrorOut		= m_DY03.oBTMMirrorOut;
	}
	if (nNo==4) {
